...
// via cliente autenticado do usuário. A função apaga profiles/subs/licenses/
// invoices/downloads e o próprio auth.users do chamador.
...
*** Add File: src/components/cookie-consent.tsx
