(function () {
  ...
  async function function31() {
    ...
    console.log("[sidepanel][validateLicense] >>> botão clicado", {
      keyProvided: !!value487,
      keyPreview: value487 ? value487.slice(0, 4) + "****" : null,
      deviceId: value449 ? value449.slice(0, 8) + "****" : "(será obtido)",
    });
    if (!value487) {
    ...
    try {
      ...
      console.log("[sidepanel][validateLicense] chamando EUBackend.validateLicense", {
        deviceId: value449.slice(0, 8) + "****",
      });
      const value489 = await window.EUBackend.validateLicense(value487, {
        deviceId: value449,
      });
      console.log("[sidepanel][validateLicense] <<< resultado", value489);
      if (value489.valid) {
